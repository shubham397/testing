...
import com.marmeto.database.DatabaseHelper;
...
public class UpdateRole extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (values != null && !values.isEmpty()) {
			...
			for (Users value : values) {
				if(!value.toString().contains("RxC")&& !value.toString().contains("Admin")){
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) { 
								...
								if(userdatasource.updatePassword(username,newPassword)){
									Intent intent = new Intent(UpdateRole.this, Success.class);
