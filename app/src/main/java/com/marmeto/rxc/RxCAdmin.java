...
public class RxCAdmin extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.rxc_admin);
	...
	private class handleUpdateSettings implements OnClickListener {
		public void onClick(View v) {
			...
			if (isConnected()) {
				...
				// SEMD REPORT
				Intent intent = new Intent(RxCAdmin.this, ApplySettings.class);

				intent.setAction(Intent.ACTION_SEND);

				String task = "updateSettings";
				intent.putExtra("task", task);
				intent.putExtra("previousPage", "rxcadmin");
	...
	private void noConnectionAlert() {
		...
		// set dialog message
		alertDialogBuilder
				.setMessage(R.string.noconnectionupdatesettings)
				.setCancelable(false)
	...
	private class handelUpdatePassword implements OnClickListener {
		...
		//open update Password Page
			Intent intent = new Intent(RxCAdmin.this, UpdateRxCRole.class);
	...
	private class handleChangeEmail implements OnClickListener {
		public void onClick(View v) {
			if (isConnected()) {
				...
				// SEMD REPORT
				Intent intent = new Intent(RxCAdmin.this, LoadingScreen.class);
