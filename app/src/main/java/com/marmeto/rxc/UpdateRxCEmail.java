...
public class UpdateRxCEmail extends Activity {
	 ...
	 */
	private void updateEmailConfirm(final String newEmail1, final String newEmail2, final String newEmail3) {
		AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
				context);
	 ...
	 */
	private void updateEmail(String newEmail1, String newEmail2, String newEmail3) {
		...
		if (isConnected()) {
			...
			try {
				...
				parent.put("group", EmailGroups.RXC_TO);
			} catch (JSONException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			// SEMD E-MAIL REQUEST
			Intent intent = new Intent(UpdateRxCEmail.this, LoadingScreen.class);
